...
<div
    class="flex min-h-[78px] w-full justify-between border border-b-0 border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8 ">
    <!--
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        <a href="{{ route('shop.home.index') }}" aria-label="@lang('shop::app.components.layouts.header.bagisto')">
            <img src="{{ core()->getCurrentChannel()->logo_url ?? bagisto_asset('images/logo.svg') }}" width="131"
                height="29" alt="{{ config('app.name') }}" class="object-cover">
        </a>
    ...
    <div class="flex items-center gap-x-9 max-[1100px]:gap-x-6 max-lg:gap-x-8">
        ...
        <div class="relative w-full">
            <form action="{{ route('shop.search.index') }}" class="flex max-w-[445px] items-center" role="search">
                ...
                <div
                    class="icon-search pointer-events-none absolute top-2.5 flex items-center text-[#030F27] text-xl ltr:left-3 rtl:right-3">
                </div>
        ...
        <div class="mt-1.5 flex gap-x-8 max-[1100px]:gap-x-6 max-lg:gap-x-8">
            ...
            <a href="{{ route('shop.compare.index') }}"
                ...
                <span class="icon-compare inline-block cursor-pointer text-2xl text-white" role="presentation"></span>
            </a>
            @endif
            ...
            <x-shop::dropdown
                ...
                <x-slot:toggle>
                    <span class="icon-users inline-block cursor-pointer text-2xl text-white" role="button"
...
<script type="text/x-template" id="v-desktop-category-template">
        ...
        >
            <div
                class="group relative flex h-[77px] text-white items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue"
