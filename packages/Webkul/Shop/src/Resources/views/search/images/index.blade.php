<v-image-search>
    <button type="button"
        class="icon-camera text-[#030F27] absolute top-3 flex items-center text-xl max-sm:top-2.5 ltr:right-3 ltr:pr-3 max-md:ltr:right-1.5 rtl:left-3 rtl:pl-3 max-md:rtl:left-1.5"
                        ...
                        if (imageInput.files[0].size <= 2000000) {
                            ...
                            this.$axios.post('{{ route('shop.search.upload') }}', formData, {
                                ...
                                .then(response => {
                                    ...
                                    }?query = ${ queryString[0] }& image - search=1`;
                                        }
